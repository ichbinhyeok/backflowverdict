...
class SiteControllerTest {
    ...
    void homePageLoads() throws Exception {
        mockMvc.perform(get("/"))
                ...
                .andExpect(content().string(containsString("Send the customer-facing brief before the office packet")))
                .andExpect(content().string(containsString("Open office workflow")))
                .andExpect(content().string(containsString("href=\"/vendors/customer-briefs\"")))
    ...
    void vendorCustomerBriefPageLoads() throws Exception {
        mockMvc.perform(get("/vendors/customer-briefs"))
                ...
                .andExpect(content().string(containsString("small busy backflow offices")))
    ...
    void vendorCustomerBriefDemoPageLoads() throws Exception {
        mockMvc.perform(get("/vendors/customer-brief-demo"))
                ...
                .andExpect(content().string(containsString("\"the test passed, but the notice is not truly closed yet\" explanation surface.")))
                .andExpect(content().string(containsString("Failed test sample")))
                .andExpect(content().string(containsString("\"it failed, what now?\" surface.")))
